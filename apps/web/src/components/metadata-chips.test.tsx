...
test("placeholder slots render as chips with their description", () => {
  render(<MetadataChips declarations={declarations} metadata={{}} />);
  expect(screen.getByTitle("Who was seen (subject)").textContent).toContain(
    "person",
  );
});
