...
// push: 8 MB for 3,000 strings in 35 languages, 43 MB for Bitwarden's
// 8,617 strings in 67 languages (#593), so the cap is sized for a few
// times the largest seen; it only has to keep a token holder from
// parking a gigabyte in memory. It applies to the body as read, after
// gunzip.
